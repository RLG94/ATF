...
export class RankingComponent implements OnInit {
  usuarios: usuario[] = [
    ...
    },
    {
      ...
      puntis: 33+2+1+1+1,
          //maria pita//desfase//desfase//conquista//inspiracion
      ganador: 1,
      posicion: null,
    ...
    },
    {
      ...
      nombre: 'Nirei Orange',
      puntis: 34+1+2+2+3+1,
              //desfase//desfase//olimpiadas//olimpiadas//olimpiadas
      ganador: 0,
      posicion: null,
      imagen:
